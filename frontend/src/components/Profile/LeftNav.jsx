...
function LeftBottom() {
    ...
    return <div className={styles.leftNavLeftBottom}>
        <button
            className={styles.leftNavLogoutButton}
            onClick={logout}
            aria-label="Logout"
            title="Logout"
        >
            <svg
                className={styles.leftNavLogoutIcon}
                viewBox="0 0 24 24"
...
function LeftNav({ id }) {
    ...
    return <div id={id} className={`${styles.leftNav} left-nav`}>
        <LeftTop />
        <div className={styles.leftNavScrollableContent}>
            <LeftMiddle endpoint={endpoint} />
            <div className={styles.leftNavSpacer} />
            <LeftBottom />
        </div>
    </div>;
}
